...
async function getTransactionFromETH(numBlock) {
    try {
        ...
        await Promise.all(blockData.transactions.map(async (element, i) => {
            ...
            transaction.value = Units.convert(convertHexToInt(element.value), 'wei', 'eth'); //unexpect 0x26748d96b29f5076000 value not support
            ...
            gasPrice = math.bignumber(Units.convert(convertHexToInt(element.gasPrice), 'wei', 'eth'));
...
console.log(Units.convert(math.bignumber(convertHexToInt('0x26748d96b29f5076000')).toFixed()/1000, 'wei', 'eth'));
console.log(math.bignumber(convertHexToInt('0x26748d96b29f5076000')).toFixed()/1000);
