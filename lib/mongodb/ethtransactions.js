...
async function getCountTransactionOut(address){
    return new Promise((resolve, reject) => {
        try {
            BlockTransaction
                .count({'from': address }).exec()
                .then(res => {
                    resolve(res)
                })
                .catch(e => reject(e));
...
async function getCountTransactionIn(address){
    return new Promise((resolve, reject) => {
        try {
            BlockTransaction
                .count({'to': address }).exec()
                .then(res => {
                    resolve(res)
                })
                .catch(e => reject(e));
...
module.exports = {
    ...
    getCountTransactionOut:         getCountTransactionOut,
    getCountTransactionIn:          getCountTransactionIn,
