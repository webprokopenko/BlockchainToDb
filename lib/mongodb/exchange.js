if(!global.appRoot) {
    ...
    global.appRoot = global.appRoot.replace('/lib/mongodb','');
}
const mongoose = require('mongoose');
if (!global.mongoose) {
mongoose.connect(require(`${appRoot}/config/config.json`).mongodbConnectionString);
}
require(`${appRoot}/models/ExchangeModel.js`);
