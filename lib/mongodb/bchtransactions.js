...
function getTransactionsList(address) {
    return new Promise((resolve, reject) => {
        try {
            BCHTransaction
                ...
                .sort({'blockheight': -1})
                .then(res => {
                    return (res ? resolve(res) : reject(new Error(`function getTransactionsList no block number`)));
                })
                .catch(e => {
                    return reject(e);
                });
...
function getCountTransaction(address){
    return new Promise((resolve, reject) => {
        try {
            BCHTransaction
                .count({$or: [
...
function getAllTransactionList(address, limit = 50 , skip = 0){
    return new Promise((resolve, reject) => {
        try {
            BCHTransaction
                .find()
                ...
                .then(res => {
                    return (res ? resolve(res) : reject(new Error(`function getAllTransactionList no block number`)));
                })
                .catch(err => {
                    return reject(err);
            })
